<?php
function registrar_categoria_documentos() {

    $labels = array(
        'name'                       => _x( 'Categorías de los Documentos', 'Taxonomy General Name', 'text_domain' ),
        'singular_name'              => _x( 'Categoría del Documento', 'Taxonomy Singular Name', 'text_domain' ),
    ...
    register_taxonomy( 'categoria_documentos', array( 'documentos' ), $args );

}

add_action( 'init', 'registrar_categoria_documentos', 0 );
